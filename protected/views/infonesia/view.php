...
<?php 
    ...
    'items'=>array(
        array(
            'image'=>Yii::app()->request->baseUrl.'/images/'.$model->namadaerah.'/'.$urlpic[0]->urlpic,),
            // 'label'=>'First Thumbnail label',
            // 'caption'=>'Cras justo odio, dapibus ac facilisis in, egestas eget quam. ' .
            // 'Donec id elit non mi porta gravida at eget metus. ' .
            // 'Nullam id dolor id nibh ultricies vehicula ut id elit.'),
        array(
            'image'=>Yii::app()->request->baseUrl.'/images/'.$model->namadaerah.'/'.$urlpic[1]->urlpic,),
            // 'label'=>'Second Thumbnail label',
            // 'caption'=>'Cras justo odio, dapibus ac facilisis in, egestas eget quam. ' .
            // 'Donec id elit non mi porta gravida at eget metus. ' .
            // 'Nullam id dolor id nibh ultricies vehicula ut id elit.'),
        array(
            'image'=>Yii::app()->request->baseUrl.'/images/'.$model->namadaerah.'/'.$urlpic[2]->urlpic,),
            // 'label'=>'Third Thumbnail label',
            // 'caption'=>'Cras justo odio, dapibus ac facilisis in, egestas eget quam. ' .
            // 'Donec id elit non mi porta gravida at eget metus. ' .
            // 'Nullam id dolor id nibh ultricies vehicula ut id elit.'),
        array(
            'image'=>Yii::app()->request->baseUrl.'/images/'.$model->namadaerah.'/'.$urlpic[3]->urlpic,),
            // 'label'=>'Third Thumbnail label',
            // 'caption'=>'Cras justo odio, dapibus ac facilisis in, egestas eget quam. ' .
            // 'Donec id elit non mi porta gravida at eget metus. ' .
            // 'Nullam id dolor id nibh ultricies vehicula ut id elit.'),
        array(
            'image'=>Yii::app()->request->baseUrl.'/images/'.$model->namadaerah.'/'.$urlpic[4]->urlpic,),
            // 'label'=>'Third Thumbnail label',
            // 'caption'=>'Cras justo odio, dapibus ac facilisis in, egestas eget quam. ' .
            // 'Donec id elit non mi porta gravida at eget metus. ' .
            // 'Nullam id dolor id nibh ultricies vehicula ut id elit.'),
